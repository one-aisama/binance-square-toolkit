...
| accounts | src/accounts/ | YAML конфиги аккаунтов, лимиты, анти-детект | баги в лимитах |
| db | src/db/ | SQLite схема и инициализация | работает |
...
- Browse profile автора: не написано
- Парсинг со сторонних сервисов: не написано
